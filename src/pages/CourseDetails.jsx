      ...
      <section className="relative w-full h-72 md:h-96 overflow-hidden rounded-b-2xl shadow-lg">
        ...
        <div className="absolute inset-0">
          <img
            ...
            alt={course.title}
            className="w-full h-full object-cover scale-105 blur-[2px]" // blur yar + zoom soft ah
          />
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center px-6 drop-shadow-lg">
          ...
          <p className=" mt-2 text-sm font-semibold text-emerald-600 uppercase tracking-wide bg-indigo-100 px-3 py-1 rounded-full backdrop-blur-sm">
            {course.type}
          </p>
        </div>
      </section>
          ...
          <div className="bg-[#edf4f5] border border-gray-200 hover:border-emerald-400 p-8 rounded-2xl shadow-lg text-center">
            ...
            {course.instructor?.image && (
              <img
                ...
                className="w-28 h-28 rounded-full object-cover mx-auto mb-4 border-4 border-indigo-100 shadow-md"
              />
            )}
