...
function SinglePostPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 lg:px-8 py-16 mt-2">
      {/* Thumbnail + Meta */}
      <div className="relative mb-8">
        ...
        />
        <div className="absolute top-4 right-4 px-4 py-1 bg-white text-sm rounded-full text-gray-700 shadow-md">
          <FaCalendarAlt className="inline text-emerald-500 mr-1" />
          {formatDate(article.date)}
        </div>
        <div className="absolute top-4 left-2 px-4 py-1 bg-white text-emerald-900 text-sm font-semibold rounded-full shadow-md">
          {article.category}
        </div>
      </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col mt-2 text-sm text-gray-600">
            <span className="font-medium text-gray-900 flex items-center gap-1">
              ...
              {author?.verified && (
                <FaCheckCircle
                  className="text-[18px] text-emerald-600 ml-1"
      ...
      <div className="mt-10  max-w-4xl mx-auto ">
        {authorLoading ? (
          ...
          <div className="flex flex-col md:flex-row  items-center md:items-start   rounded-xl shadow-md">
            ...
            {/* ✅ Dynamic Post Count */}
            <div className="mt-6 mr-2   mb-2 md:mt-0 md:ml-6 text-gray-900 text-sm font-semibold border border-emerald-400 rounded-full px-4 py-2">
              Posts{" "}
