        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="flex items-center cursor-pointer dark:hover:shadow-none gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-xl transition-all font-medium text-sm shadow-sm hover:shadow-emerald-200"
                >
                    <Plus size={18} />
                        ...
                        <div key={item._id} className={`bg-white dark:bg-slate-800 p-6 rounded-2xl border ${item.isActive ? 'border-gray-100 dark:border-gray-700' : 'border-amber-100 dark:border-amber-900/30 bg-amber-50/30 dark:bg-amber-900/10'} shadow-sm hover:shadow-md transition-all relative group flex flex-col h-full`}>
                            ...
                            <div className="flex items-center justify-end gap-2 pt-4 border-t border-gray-50 dark:border-gray-700/50 mt-auto">
                                <button
                                    ...
                                    className={`p-2 rounded-lg transition-colors ${item.isActive ? 'text-gray-400 hover:text-amber-600 bg-gray-50 dark:bg-slate-700/50 dark:hover:bg-amber-500/10' : 'text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 hover:bg-emerald-100 dark:hover:bg-emerald-500/20'}`}
                                >
                                    <ShieldCheck size={16} />
                                </button>
                                <button
                                    onClick={() => handleEdit(item)}
                                    className="p-2 text-gray-400 hover:text-emerald-600 bg-gray-50 dark:bg-slate-700/50 rounded-lg transition-colors"
                                >
                                    <PenTool size={16} />
                                </button>
                                <button
                                    onClick={() => handleDelete(item)}
                                    className="p-2 text-gray-400 hover:text-red-600 bg-gray-50 dark:bg-slate-700/50 rounded-lg transition-colors"
                                >
                                    <Trash2 size={16} />
                                </button>
                            </div>
