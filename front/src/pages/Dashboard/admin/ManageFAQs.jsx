        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="flex items-center cursor-pointer gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-xl transition-all font-medium text-sm shadow-sm hover:shadow-emerald-200 dark:shadow-none"
                >
                    <Plus size={18} />
                    <span>Add FAQ</span>
                </button>
