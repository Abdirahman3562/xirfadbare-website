                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredUsers.length > 0 ? (
                        filteredUsers.map((userItem) => (
                            <div key={userItem._id} className={`bg-white p-8 rounded-[2.5rem] border ${userItem.isActive === false ? 'border-amber-100 grayscale-[0.5]' : 'border-gray-100'} shadow-sm hover:shadow-2xl hover:shadow-emerald-100/50 transition-all duration-500 group relative overflow-hidden flex flex-col h-full border-b-4 border-b-transparent hover:border-b-emerald-500`}>
                                ...
                                <div className="space-y-1">
                                    <h3 className="text-xl font-bold text-gray-900 line-clamp-1 group-hover:text-emerald-600 transition-colors uppercase tracking-tight">{userItem.firstName} {userItem.lastName}</h3>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            className="w-full pl-12 pr-6 py-4 bg-gray-50 border border-transparent rounded-2xl outline-none focus:bg-white focus:border-emerald-500 transition-all font-bold text-gray-700 appearance-none uppercase"
                                            value={formData.role}
                ...
                <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white w-full max-w-md rounded-[3rem] shadow-2xl p-10 text-center animate-in zoom-in-95 duration-300">
                        ...
                        <p className="text-gray-500 font-medium mb-10">
                            You are about to delete <span className="font-bold text-gray-900">{selectedUser?.firstName} {selectedUser?.lastName}</span>. This action cannot be undone and will remove all their data.
                        </p>
